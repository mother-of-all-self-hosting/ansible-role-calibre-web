...
To get started, open the URL with a web browser, and log in to the instance with the administrator account (username: `admin`, password: `admin123`). **After logging in, make sure to change the credentials.**
